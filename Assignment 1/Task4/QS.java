...
class QS extends Proc{
	...
	ArrayList<Double> timeListNStart = new ArrayList<Double>();
	ArrayList<Double> timeListNEnd = new ArrayList<Double>();
	ArrayList<Double> timeListSStart = new ArrayList<Double>();
	ArrayList<Double> timeListSEnd = new ArrayList<Double>();
